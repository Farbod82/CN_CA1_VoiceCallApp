...
void AudioRecorder::record(){
    ...
    recorder->setOutputLocation(QUrl::fromLocalFile("/home/farbod/Desktop/CN_p1_v2/ca1/test.mp3"));
    ...
    decoder->setSource(QUrl::fromLocalFile("/home/farbod/Desktop/CN_p1_v2/ca1/test.mp3"));
